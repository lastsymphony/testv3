...
memberLimit = 2
ban = []
premium = ["6289670394574@s.whatsapp.net"]
...
async function starts() {
	...
	frhan.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["6289670394574@s.whatsapp.net"] // owner number ubah aja
		...
		case 'daftar':
         ...
         case 'lirik':
                ...
                if (!isPublic) return reply(mess.only.publikG)
                    ...
                    frhan.sendMessage('6289670394574@s.whatsapp.net', options, text, {quoted: mek})
